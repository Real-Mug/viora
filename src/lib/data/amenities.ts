...
export const AMENITY_CATALOGUE: Amenity[] = [
  ...
  { id: "bathtub", label: "Bathtub", category: "essentials" },
  { id: "hair-dryer", label: "Hair dryer", category: "essentials" },
  { id: "iron", label: "Iron", category: "essentials" },
  { id: "private-entrance", label: "Private entrance", category: "essentials" },
  { id: "long-term-stays", label: "Long-term stays allowed", category: "essentials" },
  { id: "pets-allowed", label: "Pets allowed", category: "essentials" },
  ...
  { id: "oven", label: "Oven and stove", category: "kitchen" },
  { id: "kettle", label: "Kettle", category: "kitchen" },
  { id: "toaster", label: "Toaster", category: "kitchen" },
  ...
  { id: "backyard", label: "Private fenced backyard", category: "outdoor" },
  ...
  { id: "security-camera", label: "Exterior security camera", category: "safety" },
  { id: "noise-monitor", label: "Noise decibel monitor", category: "safety" },
